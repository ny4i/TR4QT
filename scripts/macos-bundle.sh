...
# Code signing identity - set via SIGNING_IDENTITY env var
# For release builds: export SIGNING_IDENTITY="Developer ID Application: Your Name (TEAMID)"
# For ad-hoc signing (default): uses "-" (no Developer ID required)
